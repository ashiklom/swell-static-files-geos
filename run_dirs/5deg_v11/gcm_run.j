...
setenv SITE             NCCS
setenv GEOSDIR          /discover/nobackup/dardag/GEOS/latest/install
setenv GEOSBIN          /discover/nobackup/dardag/GEOS/latest/install/bin
setenv GEOSETC          /discover/nobackup/dardag/GEOS/latest/install/etc
setenv GEOSUTIL         /discover/nobackup/dardag/GEOS/latest/install
...
setenv  EXPID   5deg_v11
setenv  EXPDIR  /discover/nobackup/dardag/GEOS_FORWARD/testout/5deg_v11
setenv  HOMDIR  /discover/nobackup/dardag/GEOS_FORWARD/5deg_v11
...
$GEOSBIN/stripname .${year}${month}${day}_21z.$ext.Icarus-NLv3_Reynolds.CF0012x6C_TM0072xTM0036
...
setenv BCSDIR    /discover/nobackup/projects/gmao/bcs_shared/legacy_bcs/Icarus-NLv3/Icarus-NLv3_Reynolds
setenv CHMDIR    /discover/nobackup/projects/gmao/share/gmao_ops/fvInput_nc3
 setenv BCRSLV    CF0012x6C_DE0360xPE0180
setenv DATELINE  DC
setenv EMISSIONS AMIP_EMISSIONS

setenv ABCSDIR  /discover/nobackup/projects/gmao/ssd/aogcm/atmosphere_bcs/Icarus-NLv3/MOM6/CF0012x6C_TM0072xTM0036
setenv OBCSDIR  /discover/nobackup/projects/gmao/ssd/aogcm/ocean_bcs/MOM6/${OGCM_IM}x${OGCM_JM}
...
/bin/ln -sf $ABCSDIR/CF0012x6C_TM0072xTM0036-Pfafstetter.til   tile.data
## Should include this >>>MOM5<<</bin/ln -s /discover/nobackup/projects/gmao/ssd/aogcm/a48x25_o${OGCM_IM}x${OGCM_JM}/DC048xPC025_TM0072xTM0036-Pfafstetter.til tile_hist.data
## Should include this >>>MOM6<<</bin/ln -s /discover/nobackup/projects/gmao/ssd/aogcm/MOM6/DC048xPC025_TM0072xTM0036/DC048xPC025_TM0072xTM0036-Pfafstetter.til tile_hist.data
/bin/ln -sf $ABCSDIR/CF0012x6C_TM0072xTM0036-Pfafstetter.TRN   runoff.bin
...
# --------------------------------------------------------------------------------------------------
if( TM0072xTM0036 != DE0360xPE0180 ) then
    if( $yearf > $yearc ) then
       @ yearf = $yearc + 1
...
if( $USE_IOSERVER == 1 ) then
 ...
 env LD_PRELOAD=$GEOSDIR/lib/libmom6.so $RUN_CMD $TOTAL_PES $GEOSEXE $IOSERVER_OPTIONS $IOSERVER_EXTRA --logging_config 'logging.yaml'
